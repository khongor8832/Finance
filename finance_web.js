...
return z;
    ...
    //  өнөөдрийн он сар өдөр гаргах функц 
    return {
        displayDate: function(){
            var unuudur = new Date();
            document.querySelector(DOMstrings.dataLabel).textContent = unuudur.getFullYear() + " оны " + unuudur.getMonth() + "сарын";
        },
        changeType: function(){
      ...
      displayPercentages: function(allPercenttages){
        // Зарлагын Nodelist-ийг олох Node гэдэг бол DOM -ын нэг элемент өөр хэлбэл нэг tag-ыг <button id="">click me</button>
        ...
        nodeListForeach(elements, function(el, index){
          el.textContent = allPercenttages[index];
        });
  ...
  var appController = (function(uiController, financeController) {
    var ctrlAddItem = function() {
      ...
      if (input.description !== "" && input.value !== "") {
        ...
        // Дээрх мөрний бичсэн зүйлийг цэвэрлэнэ. 
        uiController.clearFields();
  
         // Төсөвийг шинээр тооцоолоод дэлгэцэнд үзүүлнэ.
        updateTusuv();
      }
    };
    ...
    var updateTusuv = function() {
      ...
      uiController.tusviigUzuuleh(tusuv);
       ...
       // 7. Элементийнүүдийн хувийг тооцоолно.
      financeController.calculatePercentages();
  
      // 8. Элементийнүүдийн тооцоолсон хувийг хүлээж авна.
